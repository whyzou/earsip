        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                <div class="form-group col-sm-6 mb-3 mb-sm-0">
                    ...
                    <input name="tanggal_masuk" type="date" class="form-control" id="tanggal_masuk" autofocus required>
                </div>
                <div class="form-group col-sm-6 mb-3 mb-sm-0">
            ...
            <div class="form-group row">
                ...
                <div class="form-group col-sm-6 mb-3 mb-sm-0">
                    ...
                    <input type="text" name="alamat_pengirim" class="form-control" id="alamat_pengirim" required>
                </div>
            </div>
